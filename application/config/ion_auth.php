 ...
 */
$config['site_title']                 = "ibetbtc Support";       // Site Title, example.com
$config['admin_email']                = "support@ibetbtc.com"; // Admin Email, admin@example.com
$config['default_group']              = 'members';           // Default group, use name
$config['admin_group']                = 'admin';             // Default administrators group, use name
$config['identity']                   = 'user_id';             // A database column which is used to login with
