...
.service('vpApi',['$http','$rootScope', '$q', 'Restangular', 'AUTH_EVENTS', '$state', 'appConfig',  function ($http, $rootScope, $q, Restangular, AUTH_EVENTS, $state, appConfig) {
  ...
  return {
    ...
    getGame: function(){
      return Restangular.one("vp_api/get_game").get();
    },
    getGames: function(){
    ...
    draw: function(params) {
      var roll = Restangular.one('vp_api/draw');
      return roll.post('draw', params);
    },
