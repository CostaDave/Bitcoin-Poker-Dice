 ...
 */
 ...
 (function ($) {
    ...
    $.jSlots = function (el, options) {
        ...
        base.Slot.prototype = {
            ...
            finish: function () {
                ...
                //$('#client_seed').val(Math.floor((Math.random() * 1000000000000000) + 1));
            }
    ...
    base.playSlots = function () {
        ...
        $.post("api/spin_wheel",{'client_seed':$('#client_seed').val()},function(result){
           result = JSON.parse(result);
           console.log(result);

           base.options.endNumbers = result.roll;
