...
CREATE TABLE `games` (
  ...
  `game_type` enum('videopoker','pokerdice','blackjack') DEFAULT NULL,
  `paytable` varchar(255) DEFAULT NULL,
  `initial_array` text,
  `shuffled_array` text,
  `server_seeds` text,
  `client_seeds` text,
...
-- ----------------------------
--  Table structure for `games_vp`
-- ----------------------------
DROP TABLE IF EXISTS `games_vp`;
CREATE TABLE `games_vp` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL,
  `initial_deck` text,
  `shuffled_deck` text,
  ...
  `client_seed` text,
  `final_array` text,
  `deals_remaining` tinyint(4) DEFAULT '2',
  `stake` int(11) DEFAULT NULL COMMENT 'kj',
  `profit` bigint(20) DEFAULT NULL,
  `winning_hand` varchar(255) DEFAULT NULL,
  `hash` varchar(255) DEFAULT NULL,
